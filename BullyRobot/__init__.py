...
if ENV:
    ...
    from BullyRobot.sample_config import Development as Config
...
telethn = TelegramClient("Bully", API_ID, API_HASH)

pbot = Client("BullyRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
